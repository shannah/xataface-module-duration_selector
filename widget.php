 ...
 */
/**
 * @brief A Dataface_FormTool wrapper for building durationselector widgets in Dataface_QuickForm forms.
 *
 ...
 *
 */
class Dataface_FormTool_durationselector{
	...
	function &buildWidget($record, &$field, $form, $formFieldName, $new=false){
		...
		$mod = $mt->loadModule('modules_durationselector');
		...
		$atts = array(
			'class' => 'xf-durationselector',
			'data-xf-durationselector-interval' => $widget['interval'],
			'data-xf-durationselector-start' => $widget['start'],
			'df:cloneable'=>1
		);
		...
		// Add our javascript
		$jt->import('xataface/widgets/durationselector.js');
