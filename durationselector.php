...
/**
 * @brief The main duration selector module class.  This loads all of the dependencies for the
 * 	module.
 *
 ...
 *
 */
 class modules_durationselector {
	/**
	 * @brief The base URL to the durationselector module.  This will be correct whether it is in the 
	...
	/**
	 * @brief Initializes the durationselector module and registers all of the event listener.
	 *
	 */
	function __construct(){
		...
		$ft->registerWidgetHandler('durationselector', dirname(__FILE__).'/widget.php', 'Dataface_FormTool_durationselector');
